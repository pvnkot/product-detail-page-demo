...
export const enum GET_SALES_DATA_ACTION {
  PENDING = 'GET_SALES_DATA_BY_PRODUCT_ID_PENDING',
  SUCCESS = 'GET_SALES_DATA_BY_PRODUCT_ID_SUCCESS',
  FAILURE = 'GET_SALES_DATA_BY_PRODUCT_ID_FAILURE',
}

export type ACTION =
  | GET_PRODUCT_DETAILS_ACTION
  | GET_PRODUCTS_LIST_ACTION
  | GET_SALES_DATA_ACTION;
